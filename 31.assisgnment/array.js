...
if (users.length === 0) {
    console.log("We nned to find some users:");
}
// Remove all users from yourarray.
// and make sure the correct message is the printed.
else {
    users = [];
    console.log("All users are removed!" + users.length);
}
